...
TEST(MusicXmlWriterTest, writeWithoutTempoChange)
{
	...
	std::string fixturePath = "MusicXmlWriterTest/expected/expected.xml";
 ...
 * @todo
 */
TEST(MusicXmlWriterTest, writeWithTempoChange)
{
}
