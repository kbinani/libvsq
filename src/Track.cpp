...
void Track::_initCor(std::string const& name, std::string const& singer)
{
	...
	curveNameMap[toLower(kBPListNamePit)]		= std::make_unique<BPList>(toLower(kBPListNamePit),			0,		-8192,	8191);
	curveNameMap[toLower(kBPListNamePbs)]		= std::make_unique<BPList>(toLower(kBPListNamePbs),			2,		0,		24);
	curveNameMap[toLower(kBPListNameDyn)]		= std::make_unique<BPList>(toLower(kBPListNameDyn),			64,		0,		127);
	curveNameMap[toLower(kBPListNameBre)]		= std::make_unique<BPList>(toLower(kBPListNameBre),			0,		0,		127);
	curveNameMap[toLower(kBPListNameBri)]		= std::make_unique<BPList>(toLower(kBPListNameBri),			64,		0,		127);
	curveNameMap[toLower(kBPListNameCle)]		= std::make_unique<BPList>(toLower(kBPListNameCle),			0,		0,		127);
	curveNameMap[toLower(kBPListNameReso1Freq)]	= std::make_unique<BPList>(toLower(kBPListNameReso1Freq),	64,		0,		127);
	curveNameMap[toLower(kBPListNameReso2Freq)] = std::make_unique<BPList>(toLower(kBPListNameReso2Freq),	64,		0,		127);
	curveNameMap[toLower(kBPListNameReso3Freq)] = std::make_unique<BPList>(toLower(kBPListNameReso3Freq),	64,		0,		127);
	curveNameMap[toLower(kBPListNameReso4Freq)] = std::make_unique<BPList>(toLower(kBPListNameReso4Freq),	64,		0,		127);
	curveNameMap[toLower(kBPListNameReso1BW)]	= std::make_unique<BPList>(toLower(kBPListNameReso1BW),		64,		0,		127);
	curveNameMap[toLower(kBPListNameReso2BW)]	= std::make_unique<BPList>(toLower(kBPListNameReso2BW),		64,		0,		127);
	curveNameMap[toLower(kBPListNameReso3BW)]	= std::make_unique<BPList>(toLower(kBPListNameReso3BW),		64,		0,		127);
	curveNameMap[toLower(kBPListNameReso4BW)]	= std::make_unique<BPList>(toLower(kBPListNameReso4BW),		64,		0,		127);
	curveNameMap[toLower(kBPListNameReso1Amp)]	= std::make_unique<BPList>(toLower(kBPListNameReso1Amp),	64,		0,		127);
	curveNameMap[toLower(kBPListNameReso2Amp)]	= std::make_unique<BPList>(toLower(kBPListNameReso2Amp),	64,		0,		127);
	curveNameMap[toLower(kBPListNameReso3Amp)]	= std::make_unique<BPList>(toLower(kBPListNameReso3Amp),	64,		0,		127);
	curveNameMap[toLower(kBPListNameReso4Amp)]	= std::make_unique<BPList>(toLower(kBPListNameReso4Amp),	64,		0,		127);
	curveNameMap[kBPListNameHarmonics]			= std::make_unique<BPList>(kBPListNameHarmonics,			64,		0,		127);
	curveNameMap[kBPListNameFx2depth]			= std::make_unique<BPList>(kBPListNameFx2depth,				64,		0,		127);
	curveNameMap[toLower(kBPListNameGen)]		= std::make_unique<BPList>(toLower(kBPListNameGen),			64,		0,		127);
	curveNameMap[toLower(kBPListNamePor)]		= std::make_unique<BPList>(toLower(kBPListNamePor),			64,		0,		127);
	curveNameMap[toLower(kBPListNameOpe)]		= std::make_unique<BPList>(toLower(kBPListNameOpe),			127,	0,		127);
