...
void MusicXmlWriter::write(Sequence const& sequence, TextOutputStream& stream, std::string const& software) const
{
	_impl->write(sequence, stream, software);
}
